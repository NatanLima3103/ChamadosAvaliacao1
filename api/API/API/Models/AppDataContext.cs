...
public class AppDataContext : DbContext
{
    ...
    {
        optionsBuilder.UseSqlite("Data Source=NatanJonatanDeLima.db");
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Chamado>().HasData(
            ...
            new Chamado { ChamadoId = "e4d2a5bd-2f9e-4csa-eb3d-5t3g8a9d1d8d", Descricao = "Trocar memória Ram", CriadoEm = DateTime.Now.AddDays(6), Status = "Aberto"}
        );
    }
}
